const imageUrl = `./public/projects`;
...
export const projects = [
  {
    ...
    image: imageUrl + 'project-01'
  },
  {
    name: 'Natours Tour Booking Application',
    description:
      'This is a full-featured tour booking application built using Express.js for the backend and MongoDB for data storage. The front-end is developed using Pug templates. This application includes features such as RESTful API design, middleware implementation, authentication, authorization, and more.',
    build: 'Development',
    image: imageUrl + 'project-02'
  },
  {
    name: 'The Wild Oasis Hotel (Client Version)',
    description:
  ...
  {
    name: 'The Wild Oasis Hotel Management App',
    description:
  ...
  {
    name: 'Travel Tracker Web Application',
    description:
  ...
  {
    name: 'Forkify Recipe Application',
    description:
